            ...
            <Row>
                ...
                <Col lg={6} md={6} sm={6}>
                 <ul className={styles.subheader_rightsec}>
                     <li><img src="/images/phone_icon.png" style={{position:'relative', top:'-1px'}}></img><span className={styles.phone_nosfont}>210-209-9222</span></li>
